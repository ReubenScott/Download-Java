package com.kindustry.net.m3u8.utils;
...
public class Log {
  ...
  public static void i(CharSequence message) {
    if (level == Constant.INFO) System.out.println("\33[0;2m" + message);
  }
  ...
  public static void setLevel(int level) {
    if (level != Constant.NONE && level != Constant.INFO && level != Constant.DEBUG && level != Constant.ERROR) throw new IllegalArgumentException("日志参数信息设置错误！");
    Log.level = level;
  }
